...
def main(chess_dict):
    ...
    return black_white(chess_dict), two_kings_alive(chess_dict), number_of_each_piece(chess_dict), valid_space(chess_dict)
...
trial7 = {'a1':'bking','a2':'wking','h1':'bpawn','h2':'bpawn','h3':'bpawn','h4':'bpawn','h5':'bpawn','h6':'bpawn','h7':'bpawn','h8':'bpawn','g7':'bpawn','g8':'bpawn', 'b2': 'brook', 'b3': 'bknight', 'b4': 'brook', 'b5': 'bknight', 'b6': 'bbishop', 'b7': 'bbishop', 'b8': 'bqueen'}#False theres more than 16 black pieces
trial8 = {'a1':'wking','a2':'wking','h1':'wpawn','h2':'wpawn','h3':'wpawn','h4':'wpawn','h5':'wpawn','h6':'wpawn','h7':'wpawn','h8':'wpawn','g7':'wpawn','g8':'wpawn', 'b2': 'wrook', 'b3': 'wknight', 'b4': 'wrook', 'b5': 'wknight', 'b6': 'wbishop', 'b7': 'wbishop', 'b8': 'bqueen'}
